...
<body>
    ...
    <b>admin您好，欢迎使用信息管理系统</b>(admin@uimaker.com)
    <a href="#">帐号设置</a>
    </div>
    
    <div class="welinfo">
    <span><img src="images/time.png" alt="时间" /></span>
    <i>您上次登录的时间：2019-8-05 15:22</i> （不是您登录的？<a href="#">请点这里</a>）
    </div>
    ...
    <li><img src="images/ico04.png" /><p><a href="#">社区讨论</a></p></li>
    <li><img src="images/ico05.png" /><p><a href="#">目录管理</a></p></li>
    <li><img src="images/ico06.png" /><p><a href="#">查询</a></p></li> 
            
    </ul>
    
    <div class="ibox"><a class="ibtn"><img src="images/iadd.png" />想要新的快捷功能，请留言</a></div>
